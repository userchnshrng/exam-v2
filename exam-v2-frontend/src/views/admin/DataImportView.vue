  ...
  <div class="data-import">
    <el-card shadow="never" class="import-card">
      ...
      <el-tabs v-model="importType">
        ...
        <el-tab-pane label="导入选择题" name="questions">
          <div class="import-desc">
...
import { importStudents, importQuestions, importExams, type ImportResult } from '@/api/importExport'
...
async function handleImport() {
  ...
  try {
    ...
    else if (importType.value === 'questions') res = await importQuestions(file.value)
