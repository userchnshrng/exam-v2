...
CREATE TABLE `exam_answer`  (
  ...
  `studentId` int NULL DEFAULT NULL COMMENT '学生学号',
  `questionType` int NULL DEFAULT NULL COMMENT '题目类型(1选择题 2填空题 3判断题)',
  `questionId` int NULL DEFAULT NULL COMMENT '题目编号',
  `studentAnswer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学生提交的答案',
  `correctAnswer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '正确答案',
  `isCorrect` tinyint(1) NULL DEFAULT 0 COMMENT '是否正确 0错误 1正确',
  `score` int NULL DEFAULT 0 COMMENT '该题实际得分',
  PRIMARY KEY (`answerId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '答题记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_answer
-- ----------------------------
INSERT INTO `exam_answer` VALUES (1, 20260001, 20154084, 1, 10013, 'B', 'C', 0, 0);
INSERT INTO `exam_answer` VALUES (2, 20260001, 20154084, 1, 10005, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (3, 20260001, 20154084, 1, 10001, '', 'D', 0, 0);
INSERT INTO `exam_answer` VALUES (4, 20260001, 20154084, 1, 10004, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (5, 20260001, 20154084, 1, 10000, '', 'C', 0, 0);
INSERT INTO `exam_answer` VALUES (6, 20260001, 20154084, 1, 10016, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (7, 20260001, 20154084, 1, 10032, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (8, 20260001, 20154084, 1, 10025, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (9, 20260001, 20154084, 1, 10030, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (10, 20260001, 20154084, 1, 10017, '', 'C', 0, 0);
INSERT INTO `exam_answer` VALUES (11, 20260001, 20154084, 1, 10027, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (12, 20260001, 20154084, 1, 10023, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (13, 20260001, 20154084, 1, 10014, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (14, 20260001, 20154084, 1, 10009, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (15, 20260001, 20154084, 1, 10008, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (16, 20260001, 20154084, 1, 10011, '', 'D', 0, 0);
INSERT INTO `exam_answer` VALUES (17, 20260001, 20154084, 1, 10010, '', 'A', 0, 0);
INSERT INTO `exam_answer` VALUES (18, 20260001, 20154084, 1, 10021, '', 'D', 0, 0);
INSERT INTO `exam_answer` VALUES (19, 20260001, 20154084, 1, 10022, '', 'B', 0, 0);
INSERT INTO `exam_answer` VALUES (20, 20260001, 20154084, 1, 10026, '', 'C', 0, 0);
INSERT INTO `exam_answer` VALUES (21, 20260001, 20154084, 2, 10017, '', '分组交换网', 0, 0);
INSERT INTO `exam_answer` VALUES (22, 20260001, 20154084, 2, 10012, '', '网络号主机号', 0, 0);
INSERT INTO `exam_answer` VALUES (23, 20260001, 20154084, 2, 10004, '', 'CERnet (或中国教育科研网)', 0, 0);
INSERT INTO `exam_answer` VALUES (24, 20260001, 20154084, 2, 10005, '', ' 广域网       局域网     城域网', 0, 0);
INSERT INTO `exam_answer` VALUES (25, 20260001, 20154084, 2, 10003, '', '同轴电缆.双绞线 光纤', 0, 0);
INSERT INTO `exam_answer` VALUES (26, 20260001, 20154084, 2, 10008, '', 'C', 0, 0);
INSERT INTO `exam_answer` VALUES (27, 20260001, 20154084, 2, 10020, '', '差错纠正  ', 0, 0);
INSERT INTO `exam_answer` VALUES (28, 20260001, 20154084, 2, 10013, '', '网络报头数据区', 0, 0);
INSERT INTO `exam_answer` VALUES (29, 20260001, 20154084, 2, 10006, '', 'POP3    SMTP    ', 0, 0);
INSERT INTO `exam_answer` VALUES (30, 20260001, 20154084, 2, 10015, '', '接口服务', 0, 0);
INSERT INTO `exam_answer` VALUES (31, 20260001, 20154084, 3, 10002, '', 'F', 0, 0);
INSERT INTO `exam_answer` VALUES (32, 20260001, 20154084, 3, 10009, '', 'T', 0, 0);
INSERT INTO `exam_answer` VALUES (33, 20260001, 20154084, 3, 10003, '', 'F', 0, 0);
INSERT INTO `exam_answer` VALUES (34, 20260001, 20154084, 3, 10005, '', 'T', 0, 0);
INSERT INTO `exam_answer` VALUES (35, 20260001, 20154084, 3, 10004, '', 'F', 0, 0);
INSERT INTO `exam_answer` VALUES (36, 20260001, 20154084, 3, 10012, '', 'F', 0, 0);
INSERT INTO `exam_answer` VALUES (37, 20260001, 20154084, 3, 10011, '', 'T', 0, 0);
INSERT INTO `exam_answer` VALUES (38, 20260001, 20154084, 3, 10006, '', 'F', 0, 0);
INSERT INTO `exam_answer` VALUES (39, 20260001, 20154084, 3, 10008, '', 'T', 0, 0);
INSERT INTO `exam_answer` VALUES (40, 20260001, 20154084, 3, 10001, '', 'T', 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 20260013 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20260001, '2025-2026学年第一学期末考试', '计算机网络', 1001, '2026-01-08', 120, '2023', '1', '计算机科学与技术', '计算机与人工智能学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20260002, '2025-2026学年第一学期末考试', '数据库理论', 1002, '2026-01-08', 90, '2023', '2', '网络工程', '计算机与人工智能学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20260003, '2025-2026学年第二学期期末考试', '数据结构', 1003, '2026-07-14', 90, '2023', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20260004, '2025-2026学年第一学期末考试', '计算机导论', 1004, '2026-01-05', 90, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (2, '晚上加班,这感觉非常的nice', '今天是星期一的晚上,下班后回到宿舍继续写我的毕业设计,看着项目功能日渐丰满好开心哦,你们也要元气满满哦！', '2026-03-18');
INSERT INTO `message` VALUES (15, '咸鱼', '我是一条咸鱼', '2026-03-18');
INSERT INTO `message` VALUES (16, '今天中午吃什么', '今天去吃莲藕排骨汤吧，虽然也不好吃，但这里真的没什么东西可以吃了', '2026-03-18');
INSERT INTO `message` VALUES (20, '这个网站不错', '博主大大好厉害，网页看着很清新呢，喜欢这样嘞风格。', '2026-03-18');
INSERT INTO `message` VALUES (21, '男孩子', '哇，这么可爱，那肯定是男孩子呀。', '2026-03-18');
INSERT INTO `message` VALUES (22, '好人', '你是个好人，可是我们不合适。', '2026-03-18');
INSERT INTO `message` VALUES (25, '小乔', '花会枯萎，爱永不凋零，小乔要努力变强。', '2026-03-18');
INSERT INTO `message` VALUES (26, '妲己', '妲己会一直爱主人，因为被设定成这样，来和妲己玩耍吧。', '2026-03-18');
INSERT INTO `message` VALUES (27, '土味情话', '妈妈从小对我讲，不要早恋，遇到你以后，我决定不听妈妈的话了。', '2026-03-31');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10032 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `notice`  (
  ...
  `content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '公告内容',
  `createTime` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '发布时间',
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, '欢迎使用在线考试系统！本次系统维护时间为今晚12点。', '2026-01-29');
...
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (26, 3, '好呀，我来了，你别跑！', '2026-03-18');
INSERT INTO `replay` VALUES (22, 4, '心疼你2秒钟', '2026-03-18');
INSERT INTO `replay` VALUES (25, 5, '我也要变强', '2026-03-19');
INSERT INTO `replay` VALUES (25, 6, '俺也一样', '2026-03-19');
INSERT INTO `replay` VALUES (21, 7, '既然这样，那就迎男而上吧', '2026-03-19');
INSERT INTO `replay` VALUES (16, 8, '那条街确实没什么东西可以吃了。。。', '2026-03-19');
INSERT INTO `replay` VALUES (15, 9, '咸鱼其实还可以吃，而你,emmmm', '2026-03-19');
INSERT INTO `replay` VALUES (21, 11, '我不怕人多', '2026-03-19');
INSERT INTO `replay` VALUES (20, 12, '是嘞，还行。', '2026-03-19');
INSERT INTO `replay` VALUES (26, 13, '我也爱你ε=(´ο｀*)))唉', '2026-03-19');
INSERT INTO `replay` VALUES (27, 14, '你这个坏孩子', '2026-03-31');
INSERT INTO `replay` VALUES (33, 18, '是的，今天是周一。', '2026-04-14');
INSERT INTO `replay` VALUES (34, 19, '1111', '2026-04-16');
INSERT INTO `replay` VALUES (34, 20, '2222', '2026-04-16');
INSERT INTO `replay` VALUES (35, 21, '666', '2026-09-05');
...
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20260001, 20154084, '计算机网络', NULL, 70, NULL, '2026-04-03');
INSERT INTO `score` VALUES (14, 20260002, 20154084, '数据库理论', NULL, 78, NULL, '2026-04-20');
INSERT INTO `score` VALUES (15, 20260002, 20154084, '数据库理论', NULL, 80, NULL, '2026-04-20');
INSERT INTO `score` VALUES (16, 20260002, 20154084, '数据库理论', NULL, 83, NULL, '2026-04-20');
INSERT INTO `score` VALUES (17, 20260001, 20154001, '计算机网络', NULL, 74, NULL, '2026-04-13');
INSERT INTO `score` VALUES (18, 20260001, 20154001, '计算机网络', NULL, 70, NULL, '2026-04-10');
INSERT INTO `score` VALUES (19, 20260001, 20155003, '计算机网络', NULL, 86, NULL, '2026-04-14');
INSERT INTO `score` VALUES (20, 20260001, 20155007, '计算机网络', NULL, 90, NULL, '2026-04-11');
INSERT INTO `score` VALUES (21, 20260001, 20155007, '计算机网络', NULL, 92, NULL, '2026-04-12');
INSERT INTO `score` VALUES (22, 20260001, 20155008, '计算机网络', NULL, 80, NULL, '2026-04-12');
INSERT INTO `score` VALUES (23, 20260001, 20155003, '计算机网络', NULL, 90, NULL, '2026-04-13');
INSERT INTO `score` VALUES (24, 20260001, 20155008, '计算机网络', NULL, 88, NULL, '2026-04-14');
INSERT INTO `score` VALUES (27, 20260001, 20154084, '计算机网络', NULL, 80, NULL, '2026-04-25');
INSERT INTO `score` VALUES (30, 20260001, 20154084, '计算机网络', NULL, 0, NULL, '2026-04-29');
INSERT INTO `score` VALUES (31, 20260001, 20154084, '计算机网络', NULL, 0, NULL, '2026-09-06');
INSERT INTO `score` VALUES (32, 20260005, 20154001, '计算机导论', NULL, 0, NULL, '2026-02-05');
INSERT INTO `score` VALUES (33, 20260001, 20154084, '计算机网络', NULL, 0, NULL, '2026-06-14');
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20230001, '翠花', '2023', '网络工程', '1', '计算机与人工智能学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2');
INSERT INTO `student` VALUES (20230002, '隔壁老王', '2023', '计算机科学与技术', '2', '计算机与人工智能学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
INSERT INTO `student` VALUES (20230003, '大咸鱼', '2023', '计算机科学与技术', '2', '计算机与人工智能学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2');
INSERT INTO `student` VALUES (20230004, '张大宝', '2023', '信息工程', '1', '计算机与人工智能学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2');
INSERT INTO `student` VALUES (20230005, '小王', '2023', '信息工程', '2', '计算机与人工智能学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2');
